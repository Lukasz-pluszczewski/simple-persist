...
if (!(globalThis as any).EventSource) (globalThis as any).EventSource = EventSourceImpl;

// Ensure fetch exists (Node 18+ has global fetch)
if (!(globalThis as any).fetch) throw new Error('Node 18+ required (global fetch)');
